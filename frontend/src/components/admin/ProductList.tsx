                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="flex-shrink-0 h-16 w-16">
                          {product.image_url ? (
                            <img className="h-16 w-16 rounded-md object-cover" src={product.image_url} alt={product.name} />
                          ) : (
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-sm text-gray-500 line-clamp-2">{product.description || 'No description'}</div>
                        </div>
                      </div>
                    </td>
